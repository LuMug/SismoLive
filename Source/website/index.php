                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <?php/*
                              ...
                              while($terremoti = $result->fetch_assoc()) {
                              echo "<tr><td>" . $row["momento_registrazione"]. "</td><td>" . $row["id_terremoto"] . "</td><td>"
                            . $row["id_gps"]. "</td><td>" . $row["latitudine"].  "</td><td>" . $row["longitudine"]. "</td></tr>";
                              }
                              echo "</table>";
                              } else { echo "0 results"; }
                              $conn->close(); */
