            ...
            <div class="container">
              ...
              <br>
                ...
                <p>L'idea iniziale di questo progetto era quella di monitorare in tempo reale i dati presi da un geofono montato su una stazione sismografica, e tramite l'apposito sito web stampare un grafico e una tabella ed avvisare tramite un email gli amministratori appena c'è il sospetto di un terremoto.
                    ...
                    <br> Ogni secondo viene registrato 1 dato randomico nell'arduino Mega 2560, questo dato è un numero che varia da 10 a 100, in base al valore che esce, viene preso e viene diviso per 10(ad esempio, esce 62 si fa /10 e il magnitudo sarà 6,2)in modo da ottenere il magnitudo, e tramite un piccolo componente chiamato fishino viene inviato al database dove, tramite la tabella "terremoto", immagazzina il dato secondo un'id.
                    <br> Un'altra colonna della tabella dove vengono immagazzinati i dati è il magnitudo, un dato numerico che può andare da 1 a 10. Infine viene registrato il momento in cui si crea il dato fittizzio e tramite una data e un'ora viene registrato.
